...
const CheckCircleIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-rain-forest" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>;
        ...
        <section className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12">
                    <div>
                        <h2 className="font-lexend text-subtitulo font-bold text-rain-forest">O que está incluso?</h2>
                    ...
                    <div className="p-8 bg-gray-50 rounded-2xl">
                        <h2 className="font-lexend text-subtitulo font-bold text-rain-forest">O que você precisa ter?</h2>
